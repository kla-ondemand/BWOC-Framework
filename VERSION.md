...
**Software-Version:** `0.1.610`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.222`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T21:01:46Z`   *(UTC, ISO 8601 — stamped on every edit)*
