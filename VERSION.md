...
**Software-Version:** `2.0.79`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.385`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T07:55:01Z`   *(UTC, ISO 8601 — stamped on every edit)*
