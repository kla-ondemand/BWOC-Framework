...
**Software-Version:** `2.0.73`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.377`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T07:45:08Z`   *(UTC, ISO 8601 — stamped on every edit)*
