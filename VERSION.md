...
**Software-Version:** `2.0.45`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.359`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T06:51:57Z`   *(UTC, ISO 8601 — stamped on every edit)*
