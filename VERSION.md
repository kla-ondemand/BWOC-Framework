...
**Software-Version:** `0.1.430`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.145`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T15:07:39Z`   *(UTC, ISO 8601 — stamped on every edit)*
