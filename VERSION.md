...
**Software-Version:** `0.1.600`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.220`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T20:48:58Z`   *(UTC, ISO 8601 — stamped on every edit)*
