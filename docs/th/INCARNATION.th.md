...
วิธีสร้าง BWOC agent ใหม่จาก template — เริ่มต้นจนถึง commit แรกภายในไม่ถึง ๓๐ นาที
...
### ๓. กรอกส่วน Identity ของ `AGENTS.md`

เปิด `AGENTS.md` แก้ Section ๑ (`Identity`):
...
**เป้าหมาย: ขั้น ๑–๖ ภายในไม่ถึง ๓๐ นาที**

---

## เพิ่ม Backend

๔ backends เริ่มต้น (Claude, Gemini, Codex, Kimi) แนบมาเป็น symlinks การเพิ่มตัวที่ห้าใช้คำสั่งเดียว:
...
- [ ] `AGENTS.md` Section ๑ สะท้อน agent นี้ (ไม่ใช่ค่าเริ่มต้นของ template)
...
2. [`docs/th/OVERVIEW.th.md`](../../modules/agent-template/docs/th/OVERVIEW.th.md) — orientation ๕ นาที
3. [`docs/th/PHILOSOPHY.th.md`](../../modules/agent-template/docs/th/PHILOSOPHY.th.md) — กรอบ ๒๒ ประการ (หมวด A–F)
...
5. [`docs/th/THREAT-MODEL.th.md`](../../modules/agent-template/docs/th/THREAT-MODEL.th.md) — ตัณหา ๓ + ศีล ๕
