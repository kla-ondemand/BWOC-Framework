...
**Software-Version:** `0.1.549`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.192`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T19:03:01Z`   *(UTC, ISO 8601 — stamped on every edit)*
