...
**Software-Version:** `0.1.594`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.216`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T20:33:10Z`   *(UTC, ISO 8601 — stamped on every edit)*
