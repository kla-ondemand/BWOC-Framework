...
**Software-Version:** `2.0.52`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.364`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T07:13:35Z`   *(UTC, ISO 8601 — stamped on every edit)*
