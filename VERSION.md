...
**Software-Version:** `0.1.636`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.235`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T01:30:41Z`   *(UTC, ISO 8601 — stamped on every edit)*
