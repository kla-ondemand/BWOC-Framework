...
**Software-Version:** `0.1.626`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.224`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T21:12:46Z`   *(UTC, ISO 8601 — stamped on every edit)*
