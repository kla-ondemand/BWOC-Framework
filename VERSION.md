...
**Software-Version:** `2.0.11`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.336`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T04:52:45Z`   *(UTC, ISO 8601 — stamped on every edit)*
