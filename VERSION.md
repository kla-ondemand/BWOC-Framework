...
**Software-Version:** `0.1.444`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.151`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T16:01:17Z`   *(UTC, ISO 8601 — stamped on every edit)*
