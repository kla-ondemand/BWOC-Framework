...
**Software-Version:** `0.1.576`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.209`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T20:10:30Z`   *(UTC, ISO 8601 — stamped on every edit)*
