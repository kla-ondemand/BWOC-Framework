...
**Software-Version:** `0.1.714`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.328`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T04:11:56Z`   *(UTC, ISO 8601 — stamped on every edit)*
