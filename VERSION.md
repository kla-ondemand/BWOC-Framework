...
**Software-Version:** `2.0.55`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.365`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T07:18:43Z`   *(UTC, ISO 8601 — stamped on every edit)*
