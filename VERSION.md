...
**Software-Version:** `0.1.478`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.169`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T17:12:57Z`   *(UTC, ISO 8601 — stamped on every edit)*
