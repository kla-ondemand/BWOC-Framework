...
**Software-Version:** `0.1.561`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.199`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T19:37:54Z`   *(UTC, ISO 8601 — stamped on every edit)*
