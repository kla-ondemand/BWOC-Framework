...
**Software-Version:** `0.1.463`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.163`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T16:45:39Z`   *(UTC, ISO 8601 — stamped on every edit)*
