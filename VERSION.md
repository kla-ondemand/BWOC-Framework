...
**Software-Version:** `0.1.569`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.207`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T19:59:34Z`   *(UTC, ISO 8601 — stamped on every edit)*
