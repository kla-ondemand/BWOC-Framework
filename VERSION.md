...
**Software-Version:** `0.1.420`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.136`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T14:47:24Z`   *(UTC, ISO 8601 — stamped on every edit)*
