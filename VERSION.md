...
**Software-Version:** `0.1.446`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.160`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T16:11:38Z`   *(UTC, ISO 8601 — stamped on every edit)*
