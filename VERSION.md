...
**Software-Version:** `0.1.484`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.171`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T17:27:01Z`   *(UTC, ISO 8601 — stamped on every edit)*
