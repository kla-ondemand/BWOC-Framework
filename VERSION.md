...
**Software-Version:** `2.0.39`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.354`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T06:28:04Z`   *(UTC, ISO 8601 — stamped on every edit)*
