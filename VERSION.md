...
**Software-Version:** `0.1.449`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.161`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T16:21:31Z`   *(UTC, ISO 8601 — stamped on every edit)*
