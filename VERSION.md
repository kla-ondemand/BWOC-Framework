...
**Software-Version:** `2.0.29`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.349`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T05:37:46Z`   *(UTC, ISO 8601 — stamped on every edit)*
