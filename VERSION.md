...
**Software-Version:** `0.1.631`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.231`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T21:29:52Z`   *(UTC, ISO 8601 — stamped on every edit)*
