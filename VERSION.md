...
**Software-Version:** `2.0.61`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.369`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T07:28:28Z`   *(UTC, ISO 8601 — stamped on every edit)*
