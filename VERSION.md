...
**Software-Version:** `2.0.67`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.373`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T07:39:20Z`   *(UTC, ISO 8601 — stamped on every edit)*
