...
Documents-first คือหลักการ Code ตามสเปก ไม่ใช่ตรงข้าม การ map กรอบ ๒๒ ประการ, วงรอบ (อุปฺปาท · ฐิติ · วยะ), โครงสร้าง workspace, และ CLI surface ถูก spec ใน Markdown ทั้งหมดก่อน Rust workspace ถูก scaffold วินัยคือ **โยนิโสมนสิการ** — ตรวจสอบเจตนาก่อนการกระทำ
...
แล้วกรอก placeholder, กำหนด persona, รัน neutrality check เป้าหมาย: commit แรกภายในไม่ถึง ๓๐ นาที walkthrough เต็มใน [`INCARNATION.th.md`](INCARNATION.th.md)
...
แหล่งความจริงเดียวคือ [`NAMING.th.md`](NAMING.th.md) — ๑๒ หมวดพร้อม decision tree สรุปเร็ว:
...
เปิด issue อธิบาย friction Framework เป็น normative แต่ไม่ infallible หลักการวิวัฒน์ผ่านวงจรอริยสัจ ๔ (ทุกข์ → สมุทัย → นิโรธ → มรรค) เดียวกับที่ขอจาก agent
