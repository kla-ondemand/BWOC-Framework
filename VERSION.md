...
**Software-Version:** `2.0.90`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.391`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-23T08:08:07Z`   *(UTC, ISO 8601 — stamped on every edit)*
