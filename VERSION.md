...
**Software-Version:** `0.1.510`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.0.178`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-05-22T18:05:08Z`   *(UTC, ISO 8601 — stamped on every edit)*
